...
public class PdfComparator<T extends CompareResult> {
    ...
    public PdfComparator(final Path expectedPath, final Path actualPath, final T compareResult) throws IOException {
        this(compareResult);
        Objects.requireNonNull(expectedPath, "expectedPath es nulo");
        Objects.requireNonNull(actualPath, "actualPath es nulo");
    ...
    public PdfComparator(final File expectedFile, final File actualFile, final T compareResult) throws IOException {
        this(compareResult);
        Objects.requireNonNull(expectedFile, "expectedFile es null");
        Objects.requireNonNull(actualFile, "actualFile es null");
    ...
    public PdfComparator(final InputStream expectedPdfIS, final InputStream actualPdfIS, final T compareResult) {
        this(compareResult);
        Objects.requireNonNull(expectedPdfIS, "expectedPdfIS es nulo");
        Objects.requireNonNull(actualPdfIS, "actualPdfIS es nulo");
